<?php
$title = empty($page['id']) ? '新規固定ページ' : '固定ページ編集';
...
<section class="admin-page">
    <div class="admin-page-header">
        <h2><?= e($title) ?></h2>
        <a class="button secondary" href="<?= url('admin/pages') ?>">固定ページ一覧へ戻る</a>
    </div>
    ...
    <form action="<?= e($action) ?>" method="post" class="post-form">
        <div class="form-group">
            ...
            <input type="text" id="title" name="title" value="<?= e($pageTitle) ?>" required>
        </div>
